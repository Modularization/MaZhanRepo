...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                    this is Login_Category
                   DESC

  s.homepage     = "https://github.com/Modularization/Login_Category"
  ...
  s.source       = { :git => "https://github.com/Modularization/Login_Category.git", :tag => s.version.to_s }
